...
if(!empty($_POST['Submit'])) {
    ...
    $commentnavi_options['pages_text']      = ! empty( $_POST['commentnavi_pages_text'] )   ? addslashes( $_POST['commentnavi_pages_text'] ) : '';
    $commentnavi_options['current_text']    = ! empty( $_POST['commentnavi_current_text'] ) ? addslashes( $_POST['commentnavi_current_text'] ) : '';
    $commentnavi_options['page_text']       = ! empty( $_POST['commentnavi_page_text'] )    ? addslashes( $_POST['commentnavi_page_text'] ) : '';
    $commentnavi_options['first_text']      = ! empty( $_POST['commentnavi_first_text'] )   ? addslashes( $_POST['commentnavi_first_text'] ) : '';
    $commentnavi_options['last_text']       = ! empty( $_POST['commentnavi_last_text'] )    ? addslashes( $_POST['commentnavi_last_text'] ) : '';
    $commentnavi_options['next_text']       = ! empty( $_POST['commentnavi_next_text'] )    ? addslashes( $_POST['commentnavi_next_text'] ) : '';
    $commentnavi_options['prev_text']       = ! empty( $_POST['commentnavi_prev_text'] )    ? addslashes( $_POST['commentnavi_prev_text'] ) : '';
    $commentnavi_options['dotright_text']   = ! empty( $_POST['commentnavi_dotright_text'] )? addslashes( $_POST['commentnavi_dotright_text'] ) : '';
    $commentnavi_options['dotleft_text']    = ! empty( $_POST['commentnavi_dotleft_text'] ) ? addslashes( $_POST['commentnavi_dotleft_text'] ) : '';
